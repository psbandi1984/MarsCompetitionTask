...
namespace MarsQACompetitionTaskNUnit.Tests
{
    ...
    public class EducationTest : BaseTest
    {
        ...
        {           
            ...
            bool recordPresent = educationPageObject.IsEducationRecordPresent(educationConfig[6].University, educationConfig[6].Country, educationConfig[6].Title, educationConfig[6].Degree, educationConfig[6].GraduationYear);
            Assert.IsTrue(recordPresent);
            Thread.Sleep(1000);
            educationPageObject.ClearEducation();
        }
        ...
        {           
            ...
            AssertionHelpers.AssertToolTipMessage(educationPageObject, educationConfig[10].AssertionMessage);
            bool recordPresent = educationPageObject.IsEducationRecordPresent(educationConfig[0].University, educationConfig[0].Country, educationConfig[0].Title, educationConfig[0].Degree, educationConfig[0].GraduationYear);
        ...
        [Test, Order(6), Description("This test add Education record with some data")]
        public void TestCreateEducationRecordWithSomeData()
        {
            educationPageObject.ClearEducation();
        ...
        [Test, Order(7), Description("This test add Education record with Invalid data")]
        ...
        [Test, Order(8), Description("This test edit Education record with Null data")]
        public void TestEditEducationRecordWithNullData()
        {
            educationPageObject.ClearEducation();
            educationPageObject.CreateEducationRecord(educationConfig[0].University, educationConfig[0].Country, educationConfig[0].Title, educationConfig[0].Degree, educationConfig[0].GraduationYear);
            educationPageObject.EditEducationRecord(educationConfig[5].University, educationConfig[5].Country, educationConfig[5].Title, educationConfig[5].Degree, educationConfig[5].GraduationYear);
            educationPageObject.UpdateButton.Click();
            educationPageObject.CancelButton.Click();
            AssertionHelpers.AssertToolTipMessage(educationPageObject, educationConfig[5].AssertionMessage);
            educationPageObject.ClearEducation();
        }

        [Test, Order(9), Description("This test edit Education record with Some data")]
        ...
        [Test, Order(10), Description("This test edit Education record with Duplicate data")]
        public void TestEditEducationRecordWithDuplicateData()
        {
            ...
            educationPageObject.EditEducationRecord(educationConfig[8].University, educationConfig[8].Country, educationConfig[8].Title, educationConfig[8].Degree, educationConfig[8].GraduationYear);            
            int rowCount = educationPageObject.RowCount();
            Assert.That(educationPageObject.RowCount(), Is.EqualTo(rowCount));
        ...
        [Test, Order(11), Description("This test edit Education record with Invalid data")]
        public void TestEditEducationRecordWithInvalidData()
        {
            educationPageObject.ClearEducation();
            educationPageObject.CreateEducationRecord(educationConfig[6].University, educationConfig[6].Country, educationConfig[6].Title, educationConfig[6].Degree, educationConfig[6].GraduationYear);
            educationPageObject.EditEducationRecord(educationConfig[9].University, educationConfig[9].Country, educationConfig[9].Title, educationConfig[9].Degree, educationConfig[9].GraduationYear);
            int rowCount = educationPageObject.RowCount();
            Assert.That(educationPageObject.RowCount(), Is.EqualTo(rowCount));
